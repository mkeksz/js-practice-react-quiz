...
export default props => {
  ...
  const loginHandler = async () => {
    ...
    try {
      const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDxqgog9IgcvRzNUQB5gC6v18as1scSMFo', authData)
  ...
  const registerHandler = async () => {
    ...
    try {
      const response = await axios.post('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDxqgog9IgcvRzNUQB5gC6v18as1scSMFo', authData)
      console.log(response)
    } catch (e) {
      console.log(e.message)
    }
